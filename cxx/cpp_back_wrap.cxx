...
#define SWIGV8_INIT cpp_back_initialize




static SwigV8ReturnValue _wrap_test_cpp(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  std::string result;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_test_cpp.");
...
#endif
{
  ...
  SWIGV8_AddStaticFunction(exports_obj, "test_cpp", _wrap_test_cpp);
...
NODE_MODULE(cpp_back, cpp_back_initialize)
#endif
